...
function menu_click() {
    ...
    for (var r = document.querySelectorAll(".pc-navbar > li:not(.pc-caption).pc-hasmenu"), o = 0; o < r.length; o++)
    ...
    for (var a = document.querySelectorAll(".pc-navbar > li:not(.pc-caption) li.pc-hasmenu"), o = 0; o < a.length; o++)
    ...
    main_layout_change(t),
        null !== t && "" !== t && (e = document.createElement("script"),
            "horizontal" === t ? (document.querySelector(".pc-sidebar").classList.add("d-none"),
                ...
                document.body.appendChild(e)) : "color-header" === t ? document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/logo-white.svg") : "compact" === t ? (e.src = "../assets/js/layout-compact.js",
...
for (var tc = document.querySelectorAll(".prod-likes .form-check-input"), t = 0; t < tc.length; t++) {
    ...
    prod_like.addEventListener("change", function (e) {
        ...
        if (t.checked)
            t.parentNode.insertAdjacentHTML("beforeend", '<div class="pc-like"><div class="like-wrapper"><span><span class="pc-group"><span class="pc-dots"></span><span class="pc-dots"></span><span class="pc-dots"></span><span class="pc-dots"></span></span></span></div></div>'),
                t.parentNode.querySelector(".pc-like").classList.add("pc-like-animate"),
                setTimeout(function () {
                    try {
                        t.parentNode.querySelector(".pc-like").remove()
                    } catch (e) {
                        console.error("Error removing like animation:", e)
                    }
                }, 3e3);
        else
            try {
