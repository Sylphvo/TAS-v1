...
namespace TAS.Migrations
{
    ...
    [Migration("20260629144138_AllowNullableFarmInIntake")]
    partial class AllowNullableFarmInIntake
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TAS.Models.RubberOrder", b =>
                {
                    ...
                    b.Property<long?>("RubberAgentAgentId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RubberAgentAgentId");

                    b.ToTable("RubberOrders");
                });
            ...
            modelBuilder.Entity("TAS.Models.RubberOrder", b =>
                {
                    b.HasOne("TAS.Helpers.RubberAgent", null)
                        .WithMany("Orders")
                        .HasForeignKey("RubberAgentAgentId");
                });
